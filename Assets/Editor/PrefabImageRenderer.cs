...
{
    /// Renders prefabs to transparent PNGs, framed like Unity's prefab preview.
    /// Shared by the one-click ingredient generator and the configurable
    /// prefab image window.
    public static class PrefabImageRenderer
    {
        ...
        public static void RenderPrefabs(IReadOnlyList<GameObject> prefabs, string outputFolder, string progressTitle)
        {
            ...
            try
            {
                for (var i = 0; i < prefabs.Count; i++)
                {
                    ...
                    EditorUtility.DisplayProgressBar(progressTitle, prefab.name, (float)i / prefabs.Count);
            ...
            Debug.Log($"Generated {prefabs.Count} prefab images into {outputFolder}");
        }
        ...
        static void RenderPrefab(GameObject prefab, string outputPath)
        {
            ...
            var cameraGo = new GameObject("PrefabImageCamera");
            var camera = cameraGo.AddComponent<Camera>();
            cameraGo.AddComponent<PrefabLightRig>();
    ...
    class PrefabLightRig : MonoBehaviour
    {
        Light _light;

        void OnEnable()
        {
            var lightGo = new GameObject("PrefabImageLight");
